...
The default pre-delivery self-check confirms the requested scope and protected contracts by inspection. Executable browser acceptance is unavailable in this deployment; when it is asked for, say so and state which preserved journeys the inspection could not exercise.
